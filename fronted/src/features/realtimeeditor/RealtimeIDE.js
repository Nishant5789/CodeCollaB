...
return (
    <div className='flex bg-teal-200 justify-center items-center h-screen'>
      <div className='bg-teal-400 shadow-purple-500 shadow-xl w-1/4 h-4/6 rounded-md space-y-2 py-4'>
        <div className='flex justify-center'>
          <img src={LOGO} className='h-28' alt="" />
        </div>
        <div className='font-bold text-center text-2xl text-white'>Please Initiazation Room ID</div>
...
/>
        ...
        <div className='flex px-4 flex-col'>
          ...
          <h1 className='text-white text-center'>IF you don't an intiate create <span className='border-b-2 border-green-600 hover:text-purple-800  text-purple-500 font-bold text-lg ' onClick={createNewRoom}>new room</span></h1>
        </div>
      </div>
      <ToastContainer />
    </div>
